export default {
  ...
  auth: {
    ...
    promoCodeValidBalance: '有效！注册后将获得 ${amount} 余额',
    promoCodeValidGift: '有效！注册后将获得 ${amount} 赠送余额，有效期 {days} 天',
    promoCodeValidGiftPermanent: '有效！注册后将获得 ${amount} 赠送余额，永久有效',
    ...
    promoGiftValidityRequired: '此赠送余额优惠码有效期配置无效，请联系管理员',
  ...
  redeem: {
    ...
    imageGenerationCharged: 'AI 生图扣费',
    imageGenerationRefunded: 'AI 生图退款',
  ...
  admin: {
    ...
    users: {
      ...
      withdrawAll: '全部',
      creditType: '入账类型',
      creditTypeBalance: '普通余额',
      creditTypeGift: '赠送余额',
      giftValidityDays: '有效时长（天）',
      giftValidityDaysRequired: '请输入有效时长，0 表示永久有效',
    ...
    announcements: {
      ...
      form: {
        ...
        markdownPasteHint: '支持 Markdown。复制图片后直接粘贴，会自动上传并插入图片；插入链接时可设置打开方式。',
        ...
        linkUrl: '链接地址',
        linkOpenMode: '打开方式',
        linkOpenModeCurrent: '当前页打开',
        linkOpenModeNewTab: '新窗口打开',
        linkRequired: '请输入链接地址',
        linkLocateFailed: '无法定位该链接',
    ...
    promo: {
      ...
      creditTypeGift: '赠送余额',
      giftValidityDays: '有效时长（天）',
      validDaysValue: '有效 {days} 天',
      validDaysPermanent: '永久有效',
      validDaysMissing: '未设置有效时长',
      giftValidityDaysRequired: '请输入有效时长，0 表示永久有效',
      maxUses: '最大使用次数',
      zeroUnlimited: '0 = 无限制',
      expiresAt: '过期时间',
