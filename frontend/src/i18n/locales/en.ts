export default {
  ...
  auth: {
    ...
    promoGiftValidityRequired: 'This gift balance promo code has no valid days. Contact an administrator.',
  ...
  admin: {
    ...
    users: {
      ...
      giftValidityDaysRequired: 'Gift balance requires valid days',
      currentBalance: 'Current Balance',
      giftBalance: 'Gift Balance',
      availableBalance: 'Available Balance',
