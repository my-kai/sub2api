export default {
  ...
  auth: {
    ...
    promoCodeValidBalance: 'Valid! You will receive ${amount} balance after registration',
    promoCodeValidGift: 'Valid! You will receive ${amount} bonus balance for {days} days',
    promoCodeValidGiftPermanent: 'Valid! You will receive ${amount} bonus balance that never expires',
    ...
    promoGiftValidityRequired: 'This gift balance promo code has invalid valid days. Contact an administrator.',
  ...
  redeem: {
    ...
    imageGenerationCharged: 'AI Image Charge',
    imageGenerationRefunded: 'AI Image Refund',
  ...
  admin: {
    ...
    users: {
      ...
      creditTypeGift: 'Gift Balance',
      giftValidityDays: 'Valid Days',
      giftValidityDaysRequired: 'Enter valid days. 0 means never expires.',
      currentBalance: 'Current Balance',
      giftBalance: 'Gift Balance',
      giftCredit: 'Gift',
      ...
      typeImageGeneration: 'Balance (AI Images)',
    ...
    redeem: {
      ...
      types: {
        ...
        image_generation: 'Balance (AI Images)',
    ...
    announcements: {
      ...
      form: {
        ...
        contentPlaceholder: 'Enter announcement content. Markdown is supported.',
        markdownPasteHint: 'Markdown is supported. Paste copied images to upload and insert them automatically; link open mode can be configured when inserting links.',
        ...
        linkUrl: 'Link URL',
        linkOpenMode: 'Open mode',
        linkOpenModeCurrent: 'Open in current page',
        linkOpenModeNewTab: 'Open in new window',
        linkRequired: 'Enter link URL',
        linkLocateFailed: 'Unable to locate this link',
    ...
    promo: {
      ...
      validDaysPermanent: 'Never expires',
      validDaysMissing: 'Valid days not set',
      giftValidityDaysRequired: 'Enter valid days. 0 means never expires.',
      maxUses: 'Max Uses',
