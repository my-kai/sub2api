...
func init() {
	...
	// usagelogDescEgressHost is the schema descriptor for egress_host field.
	usagelogDescEgressHost := usagelogFields[36].Descriptor()
	// usagelog.EgressHostValidator is a validator for the "egress_host" field. It is called by the builders before save.
	usagelog.EgressHostValidator = usagelogDescEgressHost.Validators[0].(func(string) error)
