...
// v19 combines gift-credit expiry constraints with group profit-control fields.
// Incrementing the version forces snapshots created before either field set existed to reload.
