...
// GetCallbackAuthAllowedDomains returns the normalized callback handoff allowlist.
// Read failures return an empty list so callback authorization fails closed.
