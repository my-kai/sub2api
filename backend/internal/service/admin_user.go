...
// UpdateUserBalanceInput carries explicit credit-type controls for admin balance adjustments.
...
// UpdateUserBalanceWithOptions preserves ordinary-balance updates and routes gift deposits to grant creation.
