...
func TestCheckBillingEligibility_AllowsPositiveBalanceBelowMinimumReserve(t *testing.T) {
...
func TestCheckBillingEligibility_RejectsZeroAvailableBalance(t *testing.T) {
