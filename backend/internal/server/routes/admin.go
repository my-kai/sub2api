...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/model-rate-multipliers", h.Admin.Group.GetModelRateMultipliers)
		groups.PUT("/:id/model-rate-multipliers", h.Admin.Group.BatchSetModelRateMultipliers)
		groups.DELETE("/:id/model-rate-multipliers", h.Admin.Group.ClearModelRateMultipliers)
