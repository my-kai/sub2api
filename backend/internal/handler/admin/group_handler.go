...
func NewGroupHandler(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, modelRateServices ...*modelratemultiplier.Service) *GroupHandler {
	return NewGroupHandlerWithConfig(adminService, dashboardService, groupCapacityService, nil, modelRateServices...)
}

func NewGroupHandlerWithConfig(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, cfg *config.Config, modelRateServices ...*modelratemultiplier.Service) *GroupHandler {
	h := &GroupHandler{
...
// ProvideGroupHandlerWithConfig wires both upstream runtime configuration and
// the required production model-rate dependency without a variadic Wire input.
func ProvideGroupHandlerWithConfig(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, cfg *config.Config, modelRateService *modelratemultiplier.Service) *GroupHandler {
	return NewGroupHandlerWithConfig(adminService, dashboardService, groupCapacityService, cfg, modelRateService)
}
