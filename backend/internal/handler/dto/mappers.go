...
func AccountListItemFromAccount(a *Account) *AccountListItem {
	...
	return &AccountListItem{
		...
		EgressProxyIDs: a.EgressProxyIDs, EgressIncludeLocal: a.EgressIncludeLocal, EgressCapacities: a.EgressCapacities,
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	...
	// For adjustment-like records, include notes so users can understand why balance changed.
	if (rc.Type == "admin_balance" || rc.Type == "admin_concurrency" || rc.Type == "image_generation") && rc.Notes != "" {
		out.Notes = &rc.Notes
	}
